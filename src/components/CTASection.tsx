    ...
    >
      ...
      <div className="relative z-10 container-luxury text-center max-w-3xl mx-auto">
        <div className="reveal">
          <span className="text-foreground font-body text-sm tracking-[0.3em] uppercase font-medium">
            Visit Us Today
          </span>
          ...
          <p className="font-body text-foreground text-sm font-medium mb-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="flex items-center gap-3 bg-gradient-dark text-white font-body font-bold text-base px-10 py-4 rounded-full shadow-gold hover:shadow-luxury-hover hover:-translate-y-1 transition-all duration-300 min-w-[220px] justify-center"
            >
            ...
            <a
              ...
              className="font-body font-medium text-primary-foreground/90 hover:text-foreground transition-colors duration-200 text-sm underline underline-offset-4"
            >
              Get Directions →
            </a>
          </div>
